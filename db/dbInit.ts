...
const createQueries = [
	...
	'CREATE TABLE  IF NOT EXISTS `winners` ( `id` INT NOT NULL AUTO_INCREMENT , `user_id` INT NOT NULL , `score` INT NOT NULL DEFAULT 0, `win_date` DATE NOT NULL , PRIMARY KEY (`id`),  FOREIGN KEY (`user_id`)  REFERENCES users (`id`))'
];
